...
class ap_DevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_sqlite', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'symfony', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'path' => ($this->targetDirs[2].'/data.db3'), 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    public function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['doctrine.orm.default_entity_manager'] = new DoctrineORMEntityManager_00000000158fb309000000015aac05861a16e7543c818e6e841402aac613b81d(
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('57cadf83b31972.87543785')), true);
...
class DoctrineORMEntityManager_00000000158fb309000000015aac05861a16e7543c818e6e841402aac613b81d extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder57cadf83deaf5958902135 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer57cadf83deb00009455077 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties57cadf83dead8907647022 = array(
    ...
    {
        $this->initializer57cadf83deb00009455077 && $this->initializer57cadf83deb00009455077->__invoke($this->valueHolder57cadf83deaf5958902135, $this, 'getConnection', array(), $this->initializer57cadf83deb00009455077);

        return $this->valueHolder57cadf83deaf5958902135->getConnection();
    }
    ...
    {
        $this->initializer57cadf83deb00009455077 && $this->initializer57cadf83deb00009455077->__invoke($this->valueHolder57cadf83deaf5958902135, $this, 'getMetadataFactory', array(), $this->initializer57cadf83deb00009455077);

        return $this->valueHolder57cadf83deaf5958902135->getMetadataFactory();
    }
    ...
    {
        $this->initializer57cadf83deb00009455077 && $this->initializer57cadf83deb00009455077->__invoke($this->valueHolder57cadf83deaf5958902135, $this, 'getExpressionBuilder', array(), $this->initializer57cadf83deb00009455077);

        return $this->valueHolder57cadf83deaf5958902135->getExpressionBuilder();
    }
    ...
    {
        $this->initializer57cadf83deb00009455077 && $this->initializer57cadf83deb00009455077->__invoke($this->valueHolder57cadf83deaf5958902135, $this, 'beginTransaction', array(), $this->initializer57cadf83deb00009455077);

        return $this->valueHolder57cadf83deaf5958902135->beginTransaction();
    }
    ...
    {
        $this->initializer57cadf83deb00009455077 && $this->initializer57cadf83deb00009455077->__invoke($this->valueHolder57cadf83deaf5958902135, $this, 'transactional', array('func' => $func), $this->initializer57cadf83deb00009455077);

        return $this->valueHolder57cadf83deaf5958902135->transactional($func);
    }
    ...
    {
        $this->initializer57cadf83deb00009455077 && $this->initializer57cadf83deb00009455077->__invoke($this->valueHolder57cadf83deaf5958902135, $this, 'commit', array(), $this->initializer57cadf83deb00009455077);

        return $this->valueHolder57cadf83deaf5958902135->commit();
    }
    ...
    {
        $this->initializer57cadf83deb00009455077 && $this->initializer57cadf83deb00009455077->__invoke($this->valueHolder57cadf83deaf5958902135, $this, 'rollback', array(), $this->initializer57cadf83deb00009455077);

        return $this->valueHolder57cadf83deaf5958902135->rollback();
    }
    ...
    {
        $this->initializer57cadf83deb00009455077 && $this->initializer57cadf83deb00009455077->__invoke($this->valueHolder57cadf83deaf5958902135, $this, 'getClassMetadata', array('className' => $className), $this->initializer57cadf83deb00009455077);

        return $this->valueHolder57cadf83deaf5958902135->getClassMetadata($className);
    }
    ...
    {
        $this->initializer57cadf83deb00009455077 && $this->initializer57cadf83deb00009455077->__invoke($this->valueHolder57cadf83deaf5958902135, $this, 'createQuery', array('dql' => $dql), $this->initializer57cadf83deb00009455077);

        return $this->valueHolder57cadf83deaf5958902135->createQuery($dql);
    }
    ...
    {
        $this->initializer57cadf83deb00009455077 && $this->initializer57cadf83deb00009455077->__invoke($this->valueHolder57cadf83deaf5958902135, $this, 'createNamedQuery', array('name' => $name), $this->initializer57cadf83deb00009455077);

        return $this->valueHolder57cadf83deaf5958902135->createNamedQuery($name);
    }
    ...
    {
        $this->initializer57cadf83deb00009455077 && $this->initializer57cadf83deb00009455077->__invoke($this->valueHolder57cadf83deaf5958902135, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer57cadf83deb00009455077);

        return $this->valueHolder57cadf83deaf5958902135->createNativeQuery($sql, $rsm);
    }
    ...
    {
        $this->initializer57cadf83deb00009455077 && $this->initializer57cadf83deb00009455077->__invoke($this->valueHolder57cadf83deaf5958902135, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer57cadf83deb00009455077);

        return $this->valueHolder57cadf83deaf5958902135->createNamedNativeQuery($name);
    }
    ...
    {
        $this->initializer57cadf83deb00009455077 && $this->initializer57cadf83deb00009455077->__invoke($this->valueHolder57cadf83deaf5958902135, $this, 'createQueryBuilder', array(), $this->initializer57cadf83deb00009455077);

        return $this->valueHolder57cadf83deaf5958902135->createQueryBuilder();
    }
    ...
    {
        $this->initializer57cadf83deb00009455077 && $this->initializer57cadf83deb00009455077->__invoke($this->valueHolder57cadf83deaf5958902135, $this, 'flush', array('entity' => $entity), $this->initializer57cadf83deb00009455077);

        return $this->valueHolder57cadf83deaf5958902135->flush($entity);
    }
    ...
    {
        $this->initializer57cadf83deb00009455077 && $this->initializer57cadf83deb00009455077->__invoke($this->valueHolder57cadf83deaf5958902135, $this, 'find', array('entityName' => $entityName, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer57cadf83deb00009455077);

        return $this->valueHolder57cadf83deaf5958902135->find($entityName, $id, $lockMode, $lockVersion);
    }
    ...
    {
        $this->initializer57cadf83deb00009455077 && $this->initializer57cadf83deb00009455077->__invoke($this->valueHolder57cadf83deaf5958902135, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer57cadf83deb00009455077);

        return $this->valueHolder57cadf83deaf5958902135->getReference($entityName, $id);
    }
    ...
    {
        $this->initializer57cadf83deb00009455077 && $this->initializer57cadf83deb00009455077->__invoke($this->valueHolder57cadf83deaf5958902135, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer57cadf83deb00009455077);

        return $this->valueHolder57cadf83deaf5958902135->getPartialReference($entityName, $identifier);
    }
    ...
    {
        $this->initializer57cadf83deb00009455077 && $this->initializer57cadf83deb00009455077->__invoke($this->valueHolder57cadf83deaf5958902135, $this, 'clear', array('entityName' => $entityName), $this->initializer57cadf83deb00009455077);

        return $this->valueHolder57cadf83deaf5958902135->clear($entityName);
    }
    ...
    {
        $this->initializer57cadf83deb00009455077 && $this->initializer57cadf83deb00009455077->__invoke($this->valueHolder57cadf83deaf5958902135, $this, 'close', array(), $this->initializer57cadf83deb00009455077);

        return $this->valueHolder57cadf83deaf5958902135->close();
    }
    ...
    {
        $this->initializer57cadf83deb00009455077 && $this->initializer57cadf83deb00009455077->__invoke($this->valueHolder57cadf83deaf5958902135, $this, 'persist', array('entity' => $entity), $this->initializer57cadf83deb00009455077);

        return $this->valueHolder57cadf83deaf5958902135->persist($entity);
    }
    ...
    {
        $this->initializer57cadf83deb00009455077 && $this->initializer57cadf83deb00009455077->__invoke($this->valueHolder57cadf83deaf5958902135, $this, 'remove', array('entity' => $entity), $this->initializer57cadf83deb00009455077);

        return $this->valueHolder57cadf83deaf5958902135->remove($entity);
    }
    ...
    {
        $this->initializer57cadf83deb00009455077 && $this->initializer57cadf83deb00009455077->__invoke($this->valueHolder57cadf83deaf5958902135, $this, 'refresh', array('entity' => $entity), $this->initializer57cadf83deb00009455077);

        return $this->valueHolder57cadf83deaf5958902135->refresh($entity);
    }
    ...
    {
        $this->initializer57cadf83deb00009455077 && $this->initializer57cadf83deb00009455077->__invoke($this->valueHolder57cadf83deaf5958902135, $this, 'detach', array('entity' => $entity), $this->initializer57cadf83deb00009455077);

        return $this->valueHolder57cadf83deaf5958902135->detach($entity);
    }
    ...
    {
        $this->initializer57cadf83deb00009455077 && $this->initializer57cadf83deb00009455077->__invoke($this->valueHolder57cadf83deaf5958902135, $this, 'merge', array('entity' => $entity), $this->initializer57cadf83deb00009455077);

        return $this->valueHolder57cadf83deaf5958902135->merge($entity);
    }
    ...
    {
        $this->initializer57cadf83deb00009455077 && $this->initializer57cadf83deb00009455077->__invoke($this->valueHolder57cadf83deaf5958902135, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer57cadf83deb00009455077);

        return $this->valueHolder57cadf83deaf5958902135->copy($entity, $deep);
    }
    ...
    {
        $this->initializer57cadf83deb00009455077 && $this->initializer57cadf83deb00009455077->__invoke($this->valueHolder57cadf83deaf5958902135, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer57cadf83deb00009455077);

        return $this->valueHolder57cadf83deaf5958902135->lock($entity, $lockMode, $lockVersion);
    }
    ...
    {
        $this->initializer57cadf83deb00009455077 && $this->initializer57cadf83deb00009455077->__invoke($this->valueHolder57cadf83deaf5958902135, $this, 'getRepository', array('entityName' => $entityName), $this->initializer57cadf83deb00009455077);

        return $this->valueHolder57cadf83deaf5958902135->getRepository($entityName);
    }
    ...
    {
        $this->initializer57cadf83deb00009455077 && $this->initializer57cadf83deb00009455077->__invoke($this->valueHolder57cadf83deaf5958902135, $this, 'contains', array('entity' => $entity), $this->initializer57cadf83deb00009455077);

        return $this->valueHolder57cadf83deaf5958902135->contains($entity);
    }
    ...
    {
        $this->initializer57cadf83deb00009455077 && $this->initializer57cadf83deb00009455077->__invoke($this->valueHolder57cadf83deaf5958902135, $this, 'getEventManager', array(), $this->initializer57cadf83deb00009455077);

        return $this->valueHolder57cadf83deaf5958902135->getEventManager();
    }
    ...
    {
        $this->initializer57cadf83deb00009455077 && $this->initializer57cadf83deb00009455077->__invoke($this->valueHolder57cadf83deaf5958902135, $this, 'getConfiguration', array(), $this->initializer57cadf83deb00009455077);

        return $this->valueHolder57cadf83deaf5958902135->getConfiguration();
    }
    ...
    {
        $this->initializer57cadf83deb00009455077 && $this->initializer57cadf83deb00009455077->__invoke($this->valueHolder57cadf83deaf5958902135, $this, 'isOpen', array(), $this->initializer57cadf83deb00009455077);

        return $this->valueHolder57cadf83deaf5958902135->isOpen();
    }
    ...
    {
        $this->initializer57cadf83deb00009455077 && $this->initializer57cadf83deb00009455077->__invoke($this->valueHolder57cadf83deaf5958902135, $this, 'getUnitOfWork', array(), $this->initializer57cadf83deb00009455077);

        return $this->valueHolder57cadf83deaf5958902135->getUnitOfWork();
    }
    ...
    {
        $this->initializer57cadf83deb00009455077 && $this->initializer57cadf83deb00009455077->__invoke($this->valueHolder57cadf83deaf5958902135, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer57cadf83deb00009455077);

        return $this->valueHolder57cadf83deaf5958902135->getHydrator($hydrationMode);
    }
    ...
    {
        $this->initializer57cadf83deb00009455077 && $this->initializer57cadf83deb00009455077->__invoke($this->valueHolder57cadf83deaf5958902135, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer57cadf83deb00009455077);

        return $this->valueHolder57cadf83deaf5958902135->newHydrator($hydrationMode);
    }
    ...
    {
        $this->initializer57cadf83deb00009455077 && $this->initializer57cadf83deb00009455077->__invoke($this->valueHolder57cadf83deaf5958902135, $this, 'getProxyFactory', array(), $this->initializer57cadf83deb00009455077);

        return $this->valueHolder57cadf83deaf5958902135->getProxyFactory();
    }
    ...
    {
        $this->initializer57cadf83deb00009455077 && $this->initializer57cadf83deb00009455077->__invoke($this->valueHolder57cadf83deaf5958902135, $this, 'initializeObject', array('obj' => $obj), $this->initializer57cadf83deb00009455077);

        return $this->valueHolder57cadf83deaf5958902135->initializeObject($obj);
    }
    ...
    {
        $this->initializer57cadf83deb00009455077 && $this->initializer57cadf83deb00009455077->__invoke($this->valueHolder57cadf83deaf5958902135, $this, 'getFilters', array(), $this->initializer57cadf83deb00009455077);

        return $this->valueHolder57cadf83deaf5958902135->getFilters();
    }
    ...
    {
        $this->initializer57cadf83deb00009455077 && $this->initializer57cadf83deb00009455077->__invoke($this->valueHolder57cadf83deaf5958902135, $this, 'isFiltersStateClean', array(), $this->initializer57cadf83deb00009455077);

        return $this->valueHolder57cadf83deaf5958902135->isFiltersStateClean();
    }
    ...
    {
        $this->initializer57cadf83deb00009455077 && $this->initializer57cadf83deb00009455077->__invoke($this->valueHolder57cadf83deaf5958902135, $this, 'hasFilters', array(), $this->initializer57cadf83deb00009455077);

        return $this->valueHolder57cadf83deaf5958902135->hasFilters();
    }
    ...
    {
        $this->initializer57cadf83deb00009455077 = $initializer;
    }
    ...
    {
        $this->initializer57cadf83deb00009455077 && $this->initializer57cadf83deb00009455077->__invoke($this->valueHolder57cadf83deaf5958902135, $this, '__get', array('name' => $name), $this->initializer57cadf83deb00009455077);

        if (isset(self::$publicProperties57cadf83dead8907647022[$name])) {
            return $this->valueHolder57cadf83deaf5958902135->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder57cadf83deaf5958902135;
    ...
    {
        $this->initializer57cadf83deb00009455077 && $this->initializer57cadf83deb00009455077->__invoke($this->valueHolder57cadf83deaf5958902135, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer57cadf83deb00009455077);
    ...
    {
        $this->initializer57cadf83deb00009455077 && $this->initializer57cadf83deb00009455077->__invoke($this->valueHolder57cadf83deaf5958902135, $this, '__isset', array('name' => $name), $this->initializer57cadf83deb00009455077);
    ...
    {
        $this->initializer57cadf83deb00009455077 && $this->initializer57cadf83deb00009455077->__invoke($this->valueHolder57cadf83deaf5958902135, $this, '__unset', array('name' => $name), $this->initializer57cadf83deb00009455077);
    ...
    {
        $this->initializer57cadf83deb00009455077 && $this->initializer57cadf83deb00009455077->__invoke($this->valueHolder57cadf83deaf5958902135, $this, '__clone', array(), $this->initializer57cadf83deb00009455077);

        $this->valueHolder57cadf83deaf5958902135 = clone $this->valueHolder57cadf83deaf5958902135;
    }

    public function __sleep()
    {
        $this->initializer57cadf83deb00009455077 && $this->initializer57cadf83deb00009455077->__invoke($this->valueHolder57cadf83deaf5958902135, $this, '__sleep', array(), $this->initializer57cadf83deb00009455077);

        return array('valueHolder57cadf83deaf5958902135');
    }
    ...
    {
        return $this->initializer57cadf83deb00009455077;
    }
    ...
    {
        return $this->initializer57cadf83deb00009455077 && $this->initializer57cadf83deb00009455077->__invoke($this->valueHolder57cadf83deaf5958902135, $this, 'initializeProxy', array(), $this->initializer57cadf83deb00009455077);
    }
    ...
    {
        return null !== $this->valueHolder57cadf83deaf5958902135;
    }
    ...
    {
        return $this->valueHolder57cadf83deaf5958902135;
    }
